...
set verilog_dir "/home/aya/HLS4ML_VS_MANUAL/src/hdl/RHEED_Gaussian/handmade/sv_modules/all_used_modules/"
...
set module_files [glob -directory $verilog_dir *.sv]
set module_files [lsearch -all -inline -not $module_files *_pkg_*.sv]
read_verilog -sv $module_files
# ------------------------------------------------------------------------------
...
synth_design -top rheedGaussianWrapper -mode out_of_context -rtl
# check for errors in the log here, then re-run full synthesis:

synth_design -top rheedGaussianWrapper -mode out_of_context
...
# Utilization report
set reports_dir "/home/aya/HLS4ML_VS_MANUAL/src/hdl/RHEED_Gaussian/reports/handmade_reports/"
file mkdir $reports_dir
report_utilization -hierarchical -hierarchical_depth 1 -file [file join $reports_dir "gaussian_handmade_util.rpt"]

# Optional: timing summary too
report_timing_summary -file [file join $reports_dir "gaussian_handmade_timing.rpt"]