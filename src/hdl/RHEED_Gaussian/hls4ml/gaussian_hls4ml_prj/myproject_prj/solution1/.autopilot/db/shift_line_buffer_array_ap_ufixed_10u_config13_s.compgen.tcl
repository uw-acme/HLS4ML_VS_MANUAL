...
set ID 397
set hasByteEnable 0
set MemName shift_line_buffer_array_ap_ufixed_10u_config13_s_line_buf5jm
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { kernel_window_30_V_write { I 8 vector } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { kernel_window_31_V_write { I 8 vector } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { kernel_window_32_V_write { I 8 vector } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { kernel_window_33_V_write { I 8 vector } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { kernel_window_34_V_write { I 8 vector } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { kernel_window_35_V_write { I 8 vector } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { kernel_window_36_V_write { I 8 vector } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { kernel_window_37_V_write { I 8 vector } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { kernel_window_38_V_write { I 8 vector } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { kernel_window_39_V_write { I 8 vector } } \
} "
}
