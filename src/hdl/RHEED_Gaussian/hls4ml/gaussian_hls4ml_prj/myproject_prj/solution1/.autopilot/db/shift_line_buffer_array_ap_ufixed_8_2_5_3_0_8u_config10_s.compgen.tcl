...
set ID 348
set hasByteEnable 0
set MemName shift_line_buffer_array_ap_ufixed_8_2_5_3_0_8u_config10_s_line_buffer_Array_VQgW
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { kernel_window_64_V_write { I 8 vector } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { kernel_window_65_V_write { I 8 vector } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { kernel_window_66_V_write { I 8 vector } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { kernel_window_67_V_write { I 8 vector } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { kernel_window_68_V_write { I 8 vector } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { kernel_window_69_V_write { I 8 vector } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { kernel_window_70_V_write { I 8 vector } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { kernel_window_71_V_write { I 8 vector } } \
} "
}
