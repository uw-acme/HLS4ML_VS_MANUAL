...
set ID 240
set hasByteEnable 0
set MemName shift_line_buffer_array_ap_ufixed_8u_config9_s_line_buffeHfu
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { kernel_window_24_V_write { I 8 vector } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { kernel_window_25_V_write { I 8 vector } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { kernel_window_26_V_write { I 8 vector } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { kernel_window_27_V_write { I 8 vector } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { kernel_window_28_V_write { I 8 vector } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { kernel_window_29_V_write { I 8 vector } } \
} "
}
