...
set solution_dir "/home/aya/HLS4ML_VS_MANUAL/src/hdl/RHEED_Gaussian/python/src/hdl/RHEED_Gaussian/hls4ml/gaussian_new_hls4ml_prj/myproject_prj/solution1"
set debug_dir [file join $solution_dir .debug]
set xo_hls_files_dir ""
set hdl_module_list {shift_line_buffer_array_ap_ufixed_8_0_5_3_0_1u_config2_s_line_buffer_Array_V_bkb
...
set Interfaces {
    q_conv2d_batchnorm_input_V_data_0_V {
        type "axi4stream"
        mode "slave"
        port_prefix "q_conv2d_batchnorm_input_V_data_0_V"
        has_tready "1"
        ports {
            TDATA 8
        }
    ...
    layer22_out_V_data_0_V {
        type "axi4stream"
        mode "master"
        port_prefix "layer22_out_V_data_0_V"
        has_tready "1"
        ports {
            TDATA 16
        }
    ...
    layer22_out_V_data_1_V {
        type "axi4stream"
        mode "master"
        port_prefix "layer22_out_V_data_1_V"
        has_tready "1"
        ports {
            TDATA 16
        }
    ...
    layer22_out_V_data_2_V {
        type "axi4stream"
        mode "master"
        port_prefix "layer22_out_V_data_2_V"
        has_tready "1"
        ports {
            TDATA 16
        }
    ...
    layer22_out_V_data_3_V {
        type "axi4stream"
        mode "master"
        port_prefix "layer22_out_V_data_3_V"
        has_tready "1"
        ports {
            TDATA 16
        }
    ...
    layer22_out_V_data_4_V {
        type "axi4stream"
        mode "master"
        port_prefix "layer22_out_V_data_4_V"
        has_tready "1"
        ports {
            TDATA 16
        }
    ...
    ap_clk {
        ...
        buses "q_conv2d_batchnorm_input_V_data_0_V layer22_out_V_data_0_V layer22_out_V_data_1_V layer22_out_V_data_2_V layer22_out_V_data_3_V layer22_out_V_data_4_V"
        reset "ap_rst_n"
    }
    ap_rst_n {
        type "reset"
...
## System Info
set user_parameters_list {clk_period 5 machine 64 combinational 0 latency 34571 II x}
