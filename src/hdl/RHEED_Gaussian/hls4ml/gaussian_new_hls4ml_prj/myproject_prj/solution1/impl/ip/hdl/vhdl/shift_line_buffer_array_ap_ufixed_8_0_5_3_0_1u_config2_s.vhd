...
entity shift_line_buffer_array_ap_ufixed_8_0_5_3_0_1u_config2_s is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of shift_line_buffer_array_ap_ufixed_8_0_5_3_0_1u_config2_s is 
    ...
    signal line_buffer_Array_V_1410_0_ce0 : STD_LOGIC;
    signal line_buffer_Array_V_1410_0_we0 : STD_LOGIC;
    signal line_buffer_Array_V_1410_0_q0 : STD_LOGIC_VECTOR (7 downto 0);
    signal ap_NS_fsm : STD_LOGIC_VECTOR (0 downto 0);

    component shift_line_buffer_array_ap_ufixed_8_0_5_3_0_1u_config2_s_line_buffer_Array_V_bkb IS
    generic (
        DataWidth : INTEGER;
...
begin
    line_buffer_Array_V_0_0_U : component shift_line_buffer_array_ap_ufixed_8_0_5_3_0_1u_config2_s_line_buffer_Array_V_bkb
    generic map (
        DataWidth => 8,
        AddressRange => 48,
        AddressWidth => 6)
    ...
    line_buffer_Array_V_1410_0_U : component shift_line_buffer_array_ap_ufixed_8_0_5_3_0_1u_config2_s_line_buffer_Array_V_bkb
    generic map (
        DataWidth => 8,
        AddressRange => 48,
        AddressWidth => 6)
    port map (
        ...
        reset => ap_rst,
        address0 => ap_const_lv6_2F,
        ce0 => line_buffer_Array_V_1410_0_ce0,
        we0 => line_buffer_Array_V_1410_0_we0,
        d0 => line_buffer_Array_V_0_0_q0,
        q0 => line_buffer_Array_V_1410_0_q0);
    ...
    ap_return_4 <= line_buffer_Array_V_1410_0_q0;
    ...
    line_buffer_Array_V_1410_0_ce0_assign_proc : process(ap_start, ap_CS_fsm_state1)
    begin
        if (((ap_start = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_state1))) then 
            line_buffer_Array_V_1410_0_ce0 <= ap_const_logic_1;
        else 
    ...
    line_buffer_Array_V_1410_0_we0_assign_proc : process(ap_start, ap_CS_fsm_state1)
    begin
        if (((ap_start = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_state1))) then 
            line_buffer_Array_V_1410_0_we0 <= ap_const_logic_1;
        else 
