...
sc_lv<DataWidth> ram[AddressRange];
   ...
   SC_CTOR(dense_wrapper_ap_ufixed_8_2_5_3_0_ap_fixed_8_2_5_3_0_config21_s_w21_V_ram) {
        ram[0] = "0b11000100000001111010001111100111111101";
        ram[1] = "0b01101111111000111101000000010100000000";
        ram[2] = "0b11111100010100000101001111111111111111";
        ram[3] = "0b00001011110011000000100000000111111100";
        ram[4] = "0b11111000000100000100101110111111110101";
        ram[5] = "0b01010000000101000110111111100011111111";
        ram[6] = "0b01011011110011111111000000110011111110";
        ram[7] = "0b00000011110000111100000000000000000001";
        ram[8] = "0b11110000001001000010011111111100001010";
        ram[9] = "0b00110111110011000011110000101100010011";
