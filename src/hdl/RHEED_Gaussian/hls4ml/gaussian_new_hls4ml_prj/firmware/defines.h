...
typedef nnet::array<ap_fixed<8,3>, 6*1> layer2_t;
...
typedef nnet::array<ap_fixed<8,3>, 8*1> layer6_t;
...
typedef nnet::array<ap_fixed<8,3>, 10*1> layer10_t;
...
typedef nnet::array<ap_fixed<8,3>, 15*1> layer15_t;
...
typedef nnet::array<ap_fixed<8,3>, 10*1> layer18_t;
...
typedef nnet::array<ap_fixed<8,3>, 5*1> layer21_t;
