...
set C_modelArgList {
	{ kernel_window_8_V_write int 8 regular  }
...
set C_modelArgMapList {[ 
	{ "Name" : "kernel_window_8_V_write", "interface" : "wire", "bitwidth" : 8, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ kernel_window_8_V_write sc_in sc_lv 8 signal 0 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "kernel_window_8_V_write", "direction": "in", "datatype": "sc_lv", "bitwidth":8, "type": "signal", "bundle":{"name": "kernel_window_8_V_write", "role": "default" }} , 
...
set RtlHierarchyInfo {[
	...
	{"ID" : "2", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.line_buffer_Array_V_1410_0_U", "Parent" : "0"}]}
...
set Spec2ImplPortList { 
	kernel_window_8_V_write { ap_none {  { kernel_window_8_V_write in_data 0 8 } } }
