...
module shift_line_buffer_array_ap_ufixed_8_0_5_3_0_1u_config2_s (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
output   ap_idle;
output   ap_ready;
input  [7:0] kernel_window_8_V_write;
...
reg    line_buffer_Array_V_1410_0_ce0;
reg    line_buffer_Array_V_1410_0_we0;
wire   [7:0] line_buffer_Array_V_1410_0_q0;
reg   [0:0] ap_NS_fsm;
...
always @ (*) begin
    if (((ap_start == 1'b1) & (1'b1 == ap_CS_fsm_state1))) begin
        line_buffer_Array_V_1410_0_ce0 = 1'd1;
    end else begin
        line_buffer_Array_V_1410_0_ce0 = 1'b0;
    end
end

always @ (*) begin
    if (((ap_start == 1'b1) & (1'b1 == ap_CS_fsm_state1))) begin
        line_buffer_Array_V_1410_0_we0 = 1'd1;
    end else begin
        line_buffer_Array_V_1410_0_we0 = 1'b0;
    end
end
...
assign ap_return_4 = line_buffer_Array_V_1410_0_q0;
...
endmodule //shift_line_buffer_array_ap_ufixed_8_0_5_3_0_1u_config2_s
