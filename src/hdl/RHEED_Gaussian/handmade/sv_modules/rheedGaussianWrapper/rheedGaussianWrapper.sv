module rheedGaussianWrapper #(
    ...
    conv2d_output_with_relu_reuse9_multichannel #(
        ...
        .biases      (q_conv2d_batchnorm_pkg_16_6_0::convBiases),
        .convWeights (q_conv2d_batchnorm_pkg_16_6_0::convWeights),
    ...
    conv2d_output_with_relu_reuse9_multichannel #(
        ...
        .biases      (q_conv2d_batchnorm_1_pkg_16_6_0::convBiases),
        .convWeights (q_conv2d_batchnorm_1_pkg_16_6_0::convWeights),
    ...
    conv2d_output_with_relu_reuse9_multichannel #(
        ...
        .biases      (q_conv2d_batchnorm_2_pkg_16_6_0::convBiases),
        .convWeights (q_conv2d_batchnorm_2_pkg_16_6_0::convWeights),
    ...
    denseLatencyWithControl #(
        ...
        .biases      (q_dense_pkg_16_6_0::denseBiases), 
    ...
    denseLatencyWithControl #(
        ...
        .biases      (q_dense_1_pkg_16_6_0::denseBiases),
    ...
    denseLatencyWithControl #(
        ...
        .biases      (q_dense_2_pkg_16_6_0::denseBiases),
