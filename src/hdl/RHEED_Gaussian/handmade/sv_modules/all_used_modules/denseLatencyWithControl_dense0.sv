...
module denseLatencyWithControl_dense0 #(parameter WIDTH = 16, NFRAC = 10, INPUT_SIZE = 10, OUTPUT_SIZE = 15, BITWIDTH = 16)
( clk, inputValid, biases, inputData, outputData, outputValid );
	...
	generate
	   for(i = 0; i<OUTPUT_SIZE; i++) begin: denseSums
	       sumOneColumnParameterized_dense0 #(WIDTH, NFRAC, INPUT_SIZE, OUTPUT_SIZE, i) sumColumns
