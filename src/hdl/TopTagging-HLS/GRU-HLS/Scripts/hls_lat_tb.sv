...
//     while (!layer5_out_0_V_ap_vld) @(posedge ap_clk);
...
module hls_lat_tb;
    ...
    logic ap_clk, ap_rst, ap_start, ap_done, ap_idle, ap_ready, layer1_input_V_ap_vld,layer5_out_0_V_ap_vld;
    ...
    // end
    assign out = to_real(layer5_out_0_V);
    // endgenerate
    // always_ff @(posedge ap_clk) begin
