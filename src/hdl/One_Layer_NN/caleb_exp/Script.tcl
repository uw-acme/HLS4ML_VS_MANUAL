...
synth_design -top oneLayerNN -part xcvu13p-fhga2104-3-e -generic $generics -verilog_define $defs
...
report_utilization -hierarchical -hierarchical_depth 1 -file ../caleb_exp/reports/${name}_hier.rpt
report_utilization -file ../caleb_exp/reports/${name}_util.rpt
report_timing_summary -file ../caleb_exp/reports/${name}_timing.rpt
