...
read_verilog -sv LSTM.sv quickdraw_lstm.sv  softmaxLayerNeg.sv adderTree.sv  adderTree_p4.sv  denseLayer.sv  relu.sv shift_add.sv sigmoid.sv tanh.sv 
...
synth_design -top Quickdraw_LSTM -part xcvu13p-fhga2104-3-e -generic $generics -verilog_define $defs
