...
module gru_basic #(parameter
    ...
    // Input of the model, sequence length of 15 and dimension of 6
    ...
    localparam SEQUENCE_LENGTH = 15; // should change this so parameter and not localparam
...
module gru_basic_tb;
    ...
    logic signed [WIDTH-1:0] dataOut [0:120-1];
    logic clk;
    logic reset;
    ...
    initial begin
        ...
        // Run the simulation
        // First output should (theoretically) appear after cycle 18 * 15 = 270
        repeat(330) @(posedge clk);
        $finish;
    end
