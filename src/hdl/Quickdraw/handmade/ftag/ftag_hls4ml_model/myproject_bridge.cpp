...
void myproject_float(
    ...
    input_t input_1_ap[15*6];
    nnet::convert_data<float, input_t, 15*6>(input_1, input_1_ap);

    result_t layer8_out_ap[3];

    myproject(input_1_ap,layer8_out_ap);

    nnet::convert_data<result_t, float, 3>(layer8_out_ap, layer8_out);
}
...
void myproject_double(
    ...
    input_t input_1_ap[15*6];
    nnet::convert_data<double, input_t, 15*6>(input_1, input_1_ap);

    result_t layer8_out_ap[3];

    myproject(input_1_ap,layer8_out_ap);

    nnet::convert_data<result_t, double, 3>(layer8_out_ap, layer8_out);
}
}
