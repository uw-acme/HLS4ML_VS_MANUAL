...
read_verilog -sv gru.sv gru_cell.sv quickdraw_gru.sv shift_add.sv softmaxLayerNeg.sv adderTree.sv  adderTree_p4.sv  denseLayer.sv  relu.sv shift_add.sv sigmoid.sv tanh.sv 
...
synth_design -top quickdraw_gru -part xcvu13p-fhga2104-3-e -generic $generics -verilog_define $defs
