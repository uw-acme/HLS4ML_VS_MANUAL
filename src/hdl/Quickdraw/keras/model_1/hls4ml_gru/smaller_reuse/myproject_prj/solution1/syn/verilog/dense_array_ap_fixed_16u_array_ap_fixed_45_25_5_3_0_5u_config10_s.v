...
reg   [19:0] data_0_V_reg_499;
wire    io_acc_block_signal_op4;
reg    ap_block_state1;
reg   [19:0] data_1_V_reg_504;
reg   [19:0] data_2_V_reg_509;
reg   [19:0] data_3_V_reg_514;
reg   [19:0] data_4_V_reg_519;
reg   [19:0] data_5_V_reg_524;
reg   [19:0] data_6_V_reg_529;
reg   [19:0] data_7_V_reg_534;
reg   [19:0] data_8_V_reg_539;
reg   [19:0] data_9_V_reg_544;
reg   [19:0] data_10_V_reg_549;
reg   [19:0] data_11_V_reg_554;
reg   [19:0] data_12_V_reg_559;
reg   [19:0] data_13_V_reg_564;
reg   [19:0] data_14_V_reg_569;
reg   [19:0] data_15_V_reg_574;
reg   [44:0] tmp_data_0_V_reg_579;
...
reg   [44:0] tmp_data_1_V_reg_584;
reg   [44:0] tmp_data_2_V_reg_589;
reg   [44:0] tmp_data_3_V_reg_594;
reg   [44:0] tmp_data_4_V_reg_599;
...
always @ (posedge ap_clk) begin
    if (((grp_dense_wrapper_ap_fixed_20_10_5_3_0_ap_fixed_45_25_5_3_0_config10_s_fu_375_ap_done == 1'b1) & (1'b1 == ap_CS_fsm_state2))) begin
...
always @ (*) begin
    ap_block_state1_ignore_call39 = ((real_start == 1'b0) | (io_acc_block_signal_op4 == 1'b0) | (ap_done_reg == 1'b1));
end
...
assign io_acc_block_signal_op51 = (res_stream_V_data_4_V_full_n & res_stream_V_data_3_V_full_n & res_stream_V_data_2_V_full_n & res_stream_V_data_1_V_full_n & res_stream_V_data_0_V_full_n);

assign res_stream_V_data_0_V_din = tmp_data_0_V_reg_579;

assign res_stream_V_data_1_V_din = tmp_data_1_V_reg_584;

assign res_stream_V_data_2_V_din = tmp_data_2_V_reg_589;

assign res_stream_V_data_3_V_din = tmp_data_3_V_reg_594;

assign res_stream_V_data_4_V_din = tmp_data_4_V_reg_599;
