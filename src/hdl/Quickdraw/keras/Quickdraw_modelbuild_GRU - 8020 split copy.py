...
try:
    ...
    print(auc_score)
    gru.save('./gru/Quickdraw5Class1_20.h5')
    os.system(f'printf "gru model 20 training finished" | mail -s "hello" chanssen@uw.edu')
except:
    os.system(f'printf "gru model 20 training failed" | mail -s "{error}" chanssen@uw.edu')