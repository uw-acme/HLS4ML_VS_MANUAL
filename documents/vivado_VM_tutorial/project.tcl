# This file creates a project instead of a design checkpoint. The file is a lot bulkier 
# however it gives you the ability to view the RTL. However, you need to download the entire folder
# with the verilog files and the .tcl otherwise it will not work
