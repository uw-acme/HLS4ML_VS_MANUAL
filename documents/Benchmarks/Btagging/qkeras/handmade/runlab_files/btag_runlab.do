...
# might need to change the end * to be more specific
#../
vlog "../weights/weights_dense_*_weights_biases_pkgs/dense_*_pkg_*.sv"

#vlog "../weights/dense_1_weights_biases_pkgs/dense_0_pkg_16_6_0.sv"
#vlog "../weights/dense_2_weights_biases_pkgs/dense_1_pkg_16_6_0.sv"
#vlog "../weights/dense_3_weights_biases_pkgs/dense_2_pkg_16_6_0.sv"
...
vlog "./verilog-modules/btag_benchmark.sv"
vlog "./verilog-modules/btag_benchmark_tb.sv"

#vlog "./verilog-modules/btag_benchmark_put_tb.sv"

# Call vsim to invoke simulator
#     Make sure the last item on the line is the name of the
#     testbench module you want to execute.

vsim -voptargs="+acc" -t 1ps -lib work btag_benchmark_tb

# Source the wave do file
#     This should be the file that sets up the signal window for
#     the module you are testing.
do "./wave_files/hand_nogru_wave.do"
