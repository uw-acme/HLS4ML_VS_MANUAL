...
module btag_benchmark_put_tb;
    ...
    integer i,j;
    `ifndef TESTFILE
        `define TESTFILE "../acc/testingData_noGru/zeroesData_16_6.txt"      // "toptaggingData_16_6.txt"
                                                                             // "scripts/X_test_22_8.txt"
    `endif
    `ifndef RESULTSFILE
        `define RESULTSFILE "reports/no_gru_zeroes_gen_results.txt" // "reports/gen_results.csv"
    `endif
    initial begin
