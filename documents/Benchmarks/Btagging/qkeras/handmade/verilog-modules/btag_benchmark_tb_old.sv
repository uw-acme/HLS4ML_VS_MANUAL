...
module btag_benchmark_tb_old;
    ...
    logic signed [WIDTH-1:0] input_data [timesteps-1:0] [0:INPUT_SIZE-1];
    ...
    btag_benchmark #(
        ...
        .PIPE_OUT(PIPE_OUT),
        .timesteps(timesteps)           // needed for input sizing
    ) dut (
        .clk(clk),
        .reset(reset),
    ...
    task run_test;
        ...
        input signed [WIDTH-1:0] input_d [timesteps-1:0] [0:INPUT_SIZE-1];
        input_data = input_d;
        // iteration_count = 0;
    ...
    endtask
    // max_tests = 166000;
    localparam num_tests = 19951; // 997550; // 20;
