...
`ifdef TESTFILE
module btag_benchmark_put_tb;

    // Parameters
    parameter WIDTH = 16;
    parameter NFRAC = 10;
    parameter INPUT_SIZE = 15; // 16;
    parameter OUTPUT_SIZE = 3; // 5;
    ...
    `ifndef TESTFILE
        ...
        `define TESTFILE "../acc/testingData_noGru/zeroesData_16_6.txt"       
                                                                             // "toptaggingData_16_6.txt"
                                                                             // "scripts/X_test_22_8.txt"
    `endif
    `ifndef RESULTSFILE
        `define RESULTSFILE "reports/no_gru_zeroes_gen_results.txt"    // "reports/gen_results.csv" // no_gru_zeroes_gen_results
    `endif
    initial begin
