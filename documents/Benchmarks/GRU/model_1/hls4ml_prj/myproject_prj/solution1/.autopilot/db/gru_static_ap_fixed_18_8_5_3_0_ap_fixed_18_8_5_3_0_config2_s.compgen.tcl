...
set id 185
set name myproject_mul_mul_19s_18s_28_1_1
set corename simcore_mul
set op mul
set stage_num 1
set max_latency -1
...
set out_width 28
set exp i0*i1
set arg_lists {i0 {19 1 +} i1 {18 1 +} p {28 1 +} acc {0} }
set TrueReset 0
if {${::AESL::PGuard_simmodel_gen}} {
if {[info proc ap_gen_simcore_mul] == "ap_gen_simcore_mul"} {
eval "ap_gen_simcore_mul { \
...
set id 190
set name myproject_mac_muladd_18s_18s_28s_28_1_1
...
set out_width 28
set exp i0*i1+i2
set arg_lists {i0 {18 1 +} i1 {18 1 +} m {28 1 +} i2 {28 1 +} p {28 1 +} c_reg {1} rnd {0} acc {0} }
set TrueReset 0
if {${::AESL::PGuard_simmodel_gen}} {
