...
set id 90
set name myproject_mul_mul_18s_14s_28_1_1
...
set out_width 28
set exp i0*i1
set arg_lists {i0 {18 1 +} i1 {14 1 +} p {28 1 +} acc {0} }
set TrueReset 0
...
set id 108
set name myproject_mul_mul_18s_13ns_28_1_1
set corename simcore_mul
set op mul
set stage_num 1
set max_latency -1
...
set out_width 28
set exp i0*i1
set arg_lists {i0 {18 1 +} i1 {13 0 +} p {28 1 +} acc {0} }
set TrueReset 0
if {${::AESL::PGuard_simmodel_gen}} {
if {[info proc ap_gen_simcore_mul] == "ap_gen_simcore_mul"} {
eval "ap_gen_simcore_mul { \
